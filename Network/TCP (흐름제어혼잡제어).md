...
*Assembled by GimunLee (2019-12-03)*
...
네트워크 통신에서 신뢰적인 연결 방식입니다. (`reliable network` 를 보장한다고 합니다.)

`reliable network` 를 보장한다는 것은 4가지 문제점 존재합니다.

1. packet이 손실될 수 있는 문제

2. packet의 순서가 바뀌는 문제

3. 네트워크가 혼잡한 문제 (congestion) 

4. receiver가 overload 되는 문제

이러한 문제점을 해결하기 위해 TCP 통신에서 흐름제어와 혼잡제어를 사용
